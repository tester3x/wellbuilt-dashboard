...
// ── Governed per-job acknowledgment (0.6.0, additive) ────────────────────
// WB-T sends jobRef only. Server derives identity, period, and qualifying
// read. Response is recorded | already_recorded. No evidence returned.
export { JSA_JOB_ACK_PROTOCOL_VERSION, SUPPORTED_JSA_JOB_ACK_PROTOCOL_VERSIONS, isJsaJobAckProtocolVersion, JSA_JOB_ACK_CALLABLE, JSA_JOB_ACK_AUDIENCE, JSA_JOB_ACK_METHOD, JSA_JOB_ACK_COLLECTION, JSA_JOB_ACK_ID_DOMAIN, JSA_JOB_ACK_SCHEMA_VERSION, JSA_JOB_ACK_REF_MAX, JSA_JOB_ACK_CEREMONY_ID_MAX, JSA_JOB_ACK_REF_PATTERN, JSA_JOB_ACK_CEREMONY_ID_PATTERN, isJsaJobAckJobRef, isJsaJobAckCeremonyId, isJsaJobAckObservedMs, JSA_JOB_ACK_STATES, isJsaJobAckState, JSA_JOB_ACK_REQUEST_KEYS, JSA_JOB_ACK_REQUEST_REQUIRED_KEYS, JSA_JOB_ACK_FORBIDDEN_REQUEST_KEYS, JSA_JOB_ACK_RESPONSE_KEYS, JSA_JOB_ACK_RESPONSE_FORBIDDEN_KEYS, JSA_JOB_ACK_REFUSALS, isJsaJobAckRefusal, JSA_JOB_ACK_RECORD_FORBIDDEN_KEYS, validateJsaJobAckRequest, validateJsaJobAckResponse, jsaJobAckIdPreimage, } from './sso/jsaJobAcknowledgment.js';
