 ...
 * SSO protocol lives in canonical contracts 0.3.0-dev.0, which is
...
const DEFAULT_CANONICAL = join(FN_DIR, '..', '..', 'wellbuilt-contracts', 'src', 'sso', 'protocol.ts');
const GENERATED = join(FN_DIR, 'src', 'sso', 'protocol.generated.ts');
const MANIFEST = join(FN_DIR, 'src', 'sso', 'SSO-MIRROR-MANIFEST.json');
