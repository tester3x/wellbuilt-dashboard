...
// Delete/move a pull are now governed corrections through the authenticated
// staffCorrectPull callable — see src/lib/pullCorrection.ts. The legacy direct
// RTDB write to packets/incoming was removed: the deployed secure rules deny it
