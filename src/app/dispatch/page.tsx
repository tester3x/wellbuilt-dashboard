...
import { CompliancePhotoStrip } from '@/components/CompliancePhotoStrip';
                      ...
                      {ticketDetailLoading ? (
                        ...
                        <div className="bg-[#FAFAF8] rounded-lg shadow border-l-4 border-yellow-500">
                          <div className="p-4 space-y-0">
                            ...
                            {/* Photos + AI compliance — shared renderer (same as the WB Tickets
                                modal) so the two surfaces never diverge again. */}
