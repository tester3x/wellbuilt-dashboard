...
const CAPABILITY_GROUPS: { title: string; caps: { cap: Capability; label: string; hint?: string }[] }[] = [
  {
    ...
    caps: [
      ...
      { cap: 'viewEQuipment', label: 'WB eQuipment tab' },
    ],
  },
  {
    title: 'Actions',
    caps: [
      ...
      { cap: 'manageEquipment', label: 'Equipment registry admin' },
      { cap: 'manageEquipmentAssignments', label: 'Equipment custody assignments' },
      { cap: 'viewDVIR', label: 'View submitted inspections' },
      { cap: 'manageDVIR', label: 'Manage inspections (future)' },
