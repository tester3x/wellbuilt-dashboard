...
export function TicketRouteFailure(input: { message: string; onClose: () => void }) {
  return (
    <div className="bg-[#111827] border border-red-700 rounded-lg p-6 text-white" data-paper-mode="route_failure">
