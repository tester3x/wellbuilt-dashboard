...
import { buildSpillDetailHref } from '@/lib/spill/spillDetailRoute';
              ...
              {visible.map((row) => (
                <tr key={`${row.companyId}-${row.incidentId}`} className="border-t border-gray-800 hover:bg-gray-800/60">
                  <td className="px-3 py-2">
                    <Link href={buildSpillDetailHref(row.incidentId, row.companyId)} className="text-blue-400 hover:underline">
